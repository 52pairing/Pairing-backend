package com.pairing.template_server.global.aop;
...
public class ApiLoggingAop {
    ...
    @Pointcut("execution(* com.pairing.template_server.*..presentation..*Controller.*(..))")
    private void controllerPointcut() {}

    // Application 계층 (Service, UseCase)
    @Pointcut("execution(* com.pairing.template_server.*..application..*Service.*(..)) || " +
            "execution(* com.pairing.template_server.*..application..*UseCase.*(..))")
