...
| MT_001 | 404 | 추천 라운드를 찾을 수 없음 |
| MT_002 | 404 | 후보를 찾을 수 없음 |
| MT_003 | 404 | 매칭 요청을 찾을 수 없음 |
| MT_004 | 404 | 매칭 스냅샷을 찾을 수 없음 |
| MT_005 | 400 | 모집 인원 초과 선택 |
| MT_006 | 400 | 이미 응답한 매칭 요청 |
| MT_007 | 400 | 현재 상태에서 처리할 수 없음 |
| MT_008 | 400 | 재추천을 사용할 수 없음 |
| MT_009 | 404 | 추천할 후보가 없음 |
| MT_010 | 502 | AI 매칭 서버(Pairing-python) 호출 실패 |
| MT_011 | 429 | 레이트리밋 초과 |
| MT_012 | 400 | 유료 재추천인데 quantity 누락 |
| MT_013 | 400 | 재추천 종류가 FREE/PAID가 아님(예: INITIAL) |
| MT_014 | 400 | 모집이 종료·취소된 프로젝트에 요청/재추천 시도 |
| MT_015 | 404 | 프리랜서를 찾을 수 없음(accountId↔freelancerId 또는 조건 미등록) |
| MT_016 | 400 | 응답 기한(3일)이 지나 요청이 자동 만료됨(수락/거절 시도 시) |
| MT_017 | 400 | 선택할 수 없는 후보(미노출·가드 탈락·이미 내린 후보)에게 요청 시도 — 정책 P07 |
| MT_018 | 400 | 모집 인원이 다 찬 포지션에 재추천 시도(남은 자리 0) |
